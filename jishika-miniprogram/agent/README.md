...
- 《记事卡》的核心动作很明确：整理聊天、生成需求卡、生成进度卡、整理群待办、预约沟通、打开服务名片。
...
```text
/pages/home/home?source=wechat_ai&skill=create_requirement_card&intent=requirement&context=客户说想做官网改版
```
...
首页接收到上下文后会显示提示，用户点击「继续整理」后进入对应页面。
