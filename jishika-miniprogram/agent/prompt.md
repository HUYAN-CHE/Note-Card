...
- 用户说“需求、确认、范围、要做什么”：选择 `create_requirement_card`。
- 用户说“进度、节点、补资料、到哪一步”：选择 `create_progress_card`。
...
```text
/pages/card-import/card-import?source=wechat_ai&skill=create_requirement_card&intent=requirement&context={encoded_context}
```
